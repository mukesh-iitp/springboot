...
public interface TicketDao extends CrudRepository<Ticket, Integer>{
	 ...
	 * 
	 * 
	 * When we have more than one record is available -> CRUD REPOSITORY PROVIDES COLLECTION DATA STRUCTURE AS INPUT AND OUTPUT
	 * 5.SaveAll => Input is Iterable<Entity> and Output is Iterable<Entity>
	 * 6.findAllByID => Input is (Iterable<PKVALUES>) and Output is Iterable<Entity>
	 * 
	 * 
	 * 
	 * 
