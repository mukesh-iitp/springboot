...
@NamedQueries(value= {
		...
		//NamedQuery2
		@NamedQuery(name="Person.giveFewColumns", query= "select new com.NamedQuery.model.CustomType(p.firstName, p.lastName) from Person p where p.firstName= ?1")
})
...
public class Person { 
	...
	/*
	 * IDENTITY ==> Complete Database System will manage the sequence for primary key etc.
	 * JPA will not play any role in the this generation.
	 * 
	 */
